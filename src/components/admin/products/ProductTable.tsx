...
const AllProduct = () => {
  ...
  const deleteProductReq = async (pId: string) => {
  ...
  const editProduct = (pId: string, product: Product, type: boolean) => {
    if (type) {
      dispatch({
        ...
        product: {
          ...
          pYear: product.pYear,
          pTransmission: product.pTransmission,
          pDriven: product.pDriven,
          pOwners: product.pOwners,
          pInsurance: product.pInsurance,
          pFuel: product.pFuel,
          pColour: product.pColour,
          pEngine: product.pEngine,
          pPower: product.pPower,
          pTorque: product.pTorque,
          pProductCode: product.pProductCode,
          pViews: product.pViews,
          pTag: product.pTag,
          pAbs: product.pAbs,
          pAirbags: product.pAirbags,
          pCruiseControl: product.pCruiseControl,
          pAdjustableSteer: product.pAdjustableSteer,
          pRearParkSensor: product.pRearParkSensor,
          pSunroof: product.pSunroof,
        },
      });
    }
  };
              ...
              products.map((item: Product, key: number) => {
                return (
                  <ProductTable
                    ...
                    deleteProduct={(pId: string) => deleteProductReq(pId)}
                    key={key}
                  />
                );
              })
...
interface ProductTableProps {
  ...
  editProduct: (pId: string, product: Product, type: boolean) => void;
}
