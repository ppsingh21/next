  ...
  return (
    <Fragment>
      ...
      <div
        ...
        className={` ${state.loginSignupModal ? '' : 'hidden'} fixed top-0 z-40 w-full h-screen bg-black opacity-50 cursor-pointer`}
      ></div>
      {/* Signup Login Component Render */}
      <section
        className={` ${state.loginSignupModal ? '' : 'hidden'} fixed z-40 inset-0 my-8 md:my-20 flex items-start justify-center overflow-auto`}
      >
